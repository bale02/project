    ...
    <div class="register-box-body">
        ...
        <form action="register.do" method="post">
            <div class="form-group has-feedback">
                <input type="text" name="user_Id" id="user_Id" class="form-control" placeholder="아아디">
            ...
            <div class="form-group has-feedback">
                <input type="email" name="user_Email" id="user_Email" class="form-control" placeholder="이메일">
